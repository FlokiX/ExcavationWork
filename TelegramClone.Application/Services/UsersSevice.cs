...
namespace TelegramClone.Application.Services
{
    ...
    namespace TelegramClone.Services
    {
        ...
        public class UserService : IUserService
        {
            ...
            public async Task<(Guid? userId, string error)> LoginAsync(string email, string password)
            {
                ...
                // Возвращаем userId
                return (user.Id, null); // Предполагаем, что user.Id — это идентификатор пользователя
            }
